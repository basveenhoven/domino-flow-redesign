...
export const Hero = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="container relative z-10 pt-32 pb-24 lg:pt-40 lg:pb-32">
        <div className="max-w-4xl">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-primary/40 bg-primary/10 backdrop-blur-sm mb-8 animate-fade-up" style={{ animationDelay: "0.1s" }}>
            ...
            <span className="text-xs font-medium tracking-[0.2em] uppercase text-primary">WDC 2026 — Bucketlist</span>
          </div>
          ...
          >
            ...
            Komende zomer zet het WDC team maar liefst 750.000 dominostenen op onder het thema Bucketlist.
          </p>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 hidden md:flex flex-col items-center gap-2 text-foreground/60 z-10">
