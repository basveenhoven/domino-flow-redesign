...
const sponsorsHero = scrapedImages.wdcSlider11;
...
const sponsors = [
  {
    ...
    paragraphs: [
      ...
      "Inmiddels biedt Don Domino al meer dan 30 verschillende kleuren aan en blijven ze ons verbazen door alsmaar nieuwe kleuren aan te bieden. Op de website van Don Domino staat DDT als partner vermeld en kun je onze onbevooroordeelde mening horen over de kwaliteit van de stenen.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Sinds 2019 is DDT te gast in een van de locaties van Sportservice Veenendaal. Dit jaar zijn we te gast in Sporthal de Vallei. Tijdens onze rustdag zullen we zeker een duik nemen in het zwembad.",
  ...
  return (
    <PageLayout>
      <PageHero
        ...
        subtitle="Zonder de steun van onze sponsoren zou een evenement van deze omvang niet mogelijk zijn. Een groot dankjewel aan alle partijen die met ons meebouwen."
        image={sponsorsHero}
        crumbs={[{ label: "Home", href: "/v2" }, { label: "Sponsoren" }]}
      />
